                ...
                @if(count($campaigns) > 0)
                    ...
                    @foreach ($campaigns as $campaign)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('campaigns.edit', $campaign->id) }}" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
                                <a href="{{ route('campaigns.destroy', $campaign->id) }}" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?')"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                    @endforeach
                @else
